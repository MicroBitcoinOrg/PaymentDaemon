...
from core.crypto import double_sha256, sha256
from core.format import address_to_public_key_hash, to_satoshis
from core.utils import (
	bytes_to_hex, chunk_data, hex_to_bytes, int_to_unknown_bytes, int_to_varint,
	script_push, read_bytes, read_var_int, read_var_string,
	read_segwit_string
)

from core.format import get_version
from core.base58 import b58decode_check

from core.constants import (
	MAIN_SCRIPT_HASH, MAIN_PUBKEY_HASH,
	VERSION_1, MARKER, FLAG, SEQUENCE, LOCK_TIME, HASH_TYPE,
	OP_0, OP_CHECKSIG, OP_DUP, OP_EQUALVERIFY,
...
def sanitize_tx_data(unspents, outputs, fee, leftover, combine=True,
	...
	for i, output in enumerate(outputs):
		dest, amount = output
		outputs[i] = (dest, to_satoshis(amount))
