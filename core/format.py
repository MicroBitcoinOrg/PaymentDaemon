...
from core.base58 import b58decode_check, b58encode_check
from core.crypto import ripemd160_sha256, sha256, x_to_y
from coincurve import PrivateKey as ECPrivateKey
from core.utils import int_to_unknown_bytes, hex_to_bytes, script_push
from core.constants import (
	MAIN_PUBKEY_HASH, MAIN_SCRIPT_HASH, MAIN_PRIVATE_KEY,
	PUBLIC_KEY_UNCOMPRESSED, PUBLIC_KEY_COMPRESSED_EVEN_Y,
...
def bytes_to_wif(private_key, version='main', compressed=True):
...
def wif_checksum_check(wif):
	...
	if decoded[:1] in (MAIN_PRIVATE_KEY):
		return True
